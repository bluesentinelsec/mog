 ...
 * Source: data/cacert.pem
 * Bundle date: Thu Jul 16 03:12:01 2026 GMT
 * SHA-256: 3ff344e30b9b1ed2971044eabb438a08f2e2245ddb5f8ab1a3ad8b63ab4eaf91
 * Generated (UTC): 2026-07-29T03:34:51Z
 * Size: 186446 bytes
 */
...
/afmiSTYzIw0bOIjL9kSGiG5VZFvC5F5GQytQIgLcOJ60g7YaEi7ghM5EFjp2CoHxh)MOG_CA",
    R"MOG_CA(LbWNvSO1UQ
...
lPx4mI88k1HtQJAH32RjJMtOcQWh15QaiDLxInQirqWm2BJpTGCjAu4r7NRjkgtevi9)MOG_CA",
    R"MOG_CA(2a6O2JryP
...
UNGPHgm+F6HmIcr9g+UQvIOlCsR)MOG_CA",
    R"MOG_CA(nKPZzFBQ9RnbDhxSJITRNrw9FDKZJobq7nMWxM4MphQIDAQAB
...
UzESMBAGA1UEChMJSWRlblRydXN0MSowKAYD)MOG_CA",
    R"MOG_CA(VQQDEyFJZGVuVHJ1c3QgUHVibGljIFNlY3RvciBS
...
BhMCVV)MOG_CA",
    R"MOG_CA(MxKTAnBgNVBAoTIEludGVybmV0IFNlY3VyaXR5IFJlc2VhcmNoIEdyb3VwMRUwEwYDVQQD
...
/EhOdJhCrylvLmrH+33RZjEizIYAfmaDDEL0vTSSwxrqT8p+ck0LcIymSLumoRT2+)MOG_CA",
    R"MOG_CA(1hEmRSuqguT
...
iWogD4vFsJszA1qGxliG1cGFu0/GnEBNyr7uaZa4rYEwmnySBesFK5pI0Lh2PpbIILvSsPGP2K)MOG_CA",
    R"MOG_CA(xF
...
1VdyvD/IybLeS2v4I2wDwAW9lcfNcztmgGTjGqwu+UcF8ga2m3P1eDNbx6H)MOG_CA",
    R"MOG_CA(7JyqhtJqRjJHTOoI+
...
g77FGr8H6lnco4g175x2MjxNBiLOFeXdntiP2t7S)MOG_CA",
    R"MOG_CA(xDnlF4HPOEfrf4htWRvfn0IUrn7PqLBmZdo3
...
YPxMvDVTAWqXcoKv8R1w6Jz1717CbMdHflqUhSZNO7)MOG_CA",
    R"MOG_CA(rrTOiwCcJlwp2dCZtOtZcFrPUGoPc2BX70
...
MA4GA1UdDwEB/wQEAw)MOG_CA",
    R"MOG_CA(IBBjCBxgYDVR0fBIG+MIG7MD6gPKA6hjhodHRwOi8vY3JsLmQtdHJ1c3Qu
...
IUkwDgYDVR0PAQH/BAQDAgGGMA8GA1UdEwEB/wQFMAMBAf8wDQYJKoZIhvcNAQEMB)MOG_CA",
    R"MOG_CA(QADggIBAC9c
...
/SKE8YXJN3nptT+/X)MOG_CA",
    R"MOG_CA(OR0so8RYgDdGGah2XsjX/GO1WfoVNpbOms2b/mBsTNHM3dA+VKq3dSDz4V4
...
4U/M5d40VxDJI3IXcI1QcB9WbMy5/zpaT2N6w25lBx2Eof)MOG_CA",
    R"MOG_CA(+pDGOJbbJAiDnXH3dotfyc1dZnaVuo
...
constexpr std::size_t kPemSize = 186446;
...
{
    return "Thu Jul 16 03:12:01 2026 GMT";
}

std::string_view EmbeddedMozillaCaSha256() noexcept
{
    return "3ff344e30b9b1ed2971044eabb438a08f2e2245ddb5f8ab1a3ad8b63ab4eaf91";
}
