 ...
 * Bundle date: Thu Aug 13 03:12:01 2026 GMT
 * SHA-256: f66dff1bdf8f96060b8177976f8b7d9254bc89bc4db933d769f7384d28480bc9
 * Generated (UTC): 2026-08-13T07:56:07Z
 * Size: 188900 bytes
 */
...
Um9vdCBDZXJ0aWZpY2F0ZSBBdXRob3JpdHkgLSBHMjCCASIwDQYJKoZIhvcNAQEBBQA)MOG_CA",
    R"MOG_CA(DggEPADCC
...
AyGUv/7OyjANBgkqhkiG9w0BAQsFAAOCAQEAVj3)MOG_CA",
    R"MOG_CA(vlNW92nOyWL6ukK2YJ5f+AbGwUgC4TeQbIXQb
...
MRkwFwYDVQQKExBRdW9WYWRpcyBMaW1pdGVkMR4wHAYDVQQDExV)MOG_CA",
    R"MOG_CA(RdW9WYWRpcyBSb290IENBIDEg
...
G48BtieVU+i2iW1bvGjUI+iLUaJW+fCmgKDWHrO8Dw9T)MOG_CA",
    R"MOG_CA(dSmq6hN35N6MgSGtBxBHEa2HPQfRdbzP
82Z+
-----END CERTIFICATE-----
...
PDCBBpEi6lmt2hkuIsK)MOG_CA",
    R"MOG_CA(NuYyH4Ga8cyNfIWRjgEj1oDwYPZTISEEdQLpe/v5WOaHIz16eGWRGENoX
...
Qfv6MooqtyuGC2mDOL7Nii4LcK2NJpLuHvUBKwrZ1pebbuCoGR)MOG_CA",
    R"MOG_CA(w6IYsMHkCtA+fdZn71uSANA+iW
...
8VRY+WCv2hikLyhF3HqgiIZd8zvn/yk1gPxkQ5Tm4xxvvq0OKmOZK8l+hfZx6AYDl)MOG_CA",
    R"MOG_CA(f7ej0gcWtSS
...
DgQWBBSCIS1mxteg4BXrzkwJd8RgnlRuAzANBgkqhkiG9w0BAQsFAA)MOG_CA",
    R"MOG_CA(OCAgEAYN4auOfyYILVAzOB
...
dHJvbmlxdWUxGTAXBgNVBAMMEFR1blRydXN0IFJvb3Qg)MOG_CA",
    R"MOG_CA(Q0EwHhcNMTkwNDI2MDg1NzU2WhcNNDQw
...
7zNKpiMdDg1H2DfHb680f0+BazVP6XKlMeJ45/dOlBhbQH3PayFUhuaVevvGyuqcS)MOG_CA",
    R"MOG_CA(E5XCV0vrPSl
...
=================
-----BEGIN CERTIFICATE-----
MIIFRzCCAy+gAwIBAgIRAI4P+UuQcWhlM1T01E)MOG_CA",
    R"MOG_CA(Q5t+AwDQYJKoZIhvcNAQELBQAwPTELMAkGA1UE
...
81a4Jl9nOAuc0)MOG_CA",
    R"MOG_CA(DAdBgNVHQ4EFgQUiY8vo+groBRUe/NWuCZfZzgLnNAwDgYDVR0PAQH/BAQDAgGG
...
jVIHvXiby8posqTdD)MOG_CA",
    R"MOG_CA(Ex5YMaZ0ZPxMBoH064iwurO8YQJzOAUbn8/ftKChazcqRZOhaBgy/ac18iz
...
constexpr std::size_t kPemSize = 188900;
...
{
    return "Thu Aug 13 03:12:01 2026 GMT";
}

std::string_view EmbeddedMozillaCaSha256() noexcept
{
    return "f66dff1bdf8f96060b8177976f8b7d9254bc89bc4db933d769f7384d28480bc9";
}
