...
# miniz: tiny zlib-compatible inflate/deflate; static only for shipping without
# a system libz. Used by the embedded backend for Content-Encoding handling.
#
# We populate sources and define our own static target rather than using
# miniz's upstream CMakeLists (cmake_minimum_required 3.0 is rejected by modern
# CMake). Same sources, static-only, no install rules.
FetchContent_Declare(
  miniz
...
if(NOT TARGET miniz)
  ...
  # Static build: export macros expand empty (see miniz_export.h).
  target_compile_definitions(miniz PUBLIC MINIZ_STATIC_DEFINE)
  set_target_properties(miniz PROPERTIES
    C_STANDARD 99
    POSITION_INDEPENDENT_CODE ON
  )
  # Provide a minimal export header when not generated by upstream CMake.
